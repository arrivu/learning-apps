...
CoursePreview.create!(
          ...
          # Contact.create!(
          # 	name: "Arrivu infotech",
          # 	email: "arrivusystems@gmail.com",
          # 	message: "We love to hear from Arrivu fans and future fans - after all,
...
Course.create!(title: "Algorithm Using Program",
      desc: "Learn Algorithm using the language of Program",
      topic_id: 1,
...
Course.create!(title: "SOCIAL MEDIA",
      desc: "Learn web applications and create new social media",
      topic_id: 2,
...
Course.create!(title:"Technology of Networking",
      desc: "Learn Big data send and receive using the language of Networking",
      topic_id: 3,
  ...
  CoursePricing.create!(course_id: "1" ,
          price: "9000" ,
          start_date: "2013-08-01",
          end_date: "2014-08-31",
          account_id:2)

CoursePricing.create!(course_id: "2" ,
          price: "10000" ,
          start_date: "2013-08-01",
          end_date: "2014-08-31",
          account_id:2)
  CoursePricing.create!(course_id: "3" ,
          price: "12000" ,
          start_date: "2013-08-01",
          end_date: "2014-08-31",
          account_id:2)
